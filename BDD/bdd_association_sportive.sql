...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 19 nov. 2021 à 20:43
...
INSERT INTO `entrainement` (`id`, `id_equipe`, `lieu`, `date_heure`) VALUES
(1, 1, '50 rue de la poutre - LAVILLE', '2021-11-28 21:22:36');
...
ALTER TABLE `entrainement`
  ADD CONSTRAINT `id_equipe_tri` FOREIGN KEY (`id_equipe`) REFERENCES `equipe` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
